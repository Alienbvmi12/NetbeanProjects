...
stok.setText("");
   ...
   public void TampilData() {
    ...
    private void initComponents() {
        ...
        clear.setBackground(new java.awt.Color(41, 128, 185));
        ...
        Reset.setIcon(new javax.swing.ImageIcon(getClass().getResource("/foto/recurring-appointment-16.png"))); // NOI18N
        Reset.setText("Reset");
    ...
    private void editMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editMouseClicked
        try{
            ...
            String SQL = "update barang SET id_barang = '"+id.getText()+"', deskripsi= '"+spec.getText()+"', nama_barang = '"+kateg.getText()+"', merk = '"+merk.getText()+"', stok = '"+stok.getText()+"' where id_barang = '"+id.getText()+"'";
    ...
    private void clearMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_clearMouseEntered
        clear.setBackground(new Color (44, 62, 80));
